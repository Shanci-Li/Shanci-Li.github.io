...
<button class="button" onclick="changeContactPeople('Theresa May')"><img src="/img/theresa.jpg" style="width:20%; height=20%;"></button>
<button class="button" onclick="changeContactPeople('Boris Johnson')"><img src="/img/boris.jpg" style="width:20%; height=20%;"></button>
<button class="button" onclick="changeContactPeople('Nigel Farage')"><img src="/img/nigel.jpg" style="width:20%; height=20%;"></button>
<button class="button" onclick="changeContactPeople('Jeremy Corbyn')"><img src="/img/jeremy.jpg" style="width:20%; height=20%;"></button>
